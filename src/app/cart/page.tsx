              ...
              <React.Fragment key={item.id}>
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6 p-4 sm:p-6">
                  ...
                  <div className="flex-1 sm:ml-6 w-full">
                    ...
                    {/* Quantity Controls */}
                    <div className="flex flex-col sm:flex-row items-start align-middle sm:items-center justify-between gap-2 mt-4">
                      <div className="flex flex-wrap items-center gap-3">
                        <label
                          htmlFor={`quantity-${item.id}`}
                          className="text-sm font-medium text-gray-700 mr-0 sm:mr-4"
                        >
                          Количество:
                        </label>
                      ...
                      {/* Item Total */}
                      <div className="ml-0 sm:ml-auto w-full sm:w-auto mt-2 sm:mt-0 text-right sm:text-left">
